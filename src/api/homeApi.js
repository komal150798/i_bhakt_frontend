...
export const homeApi = {
  ...
  getDailyHoroscope: async (sign) => {
    const response = await httpClient.get(`${HOME_ENDPOINTS.HOROSCOPE}/daily`, {
      params: { sign },
    });
    return response.data;
  },
  ...
  getWeeklyHoroscope: async (sign) => {
    const response = await httpClient.get(`${HOME_ENDPOINTS.HOROSCOPE}/weekly`, {
      params: { sign },
    });
    return response.data;
  },
  ...
  getMonthlyHoroscope: async (sign) => {
    const response = await httpClient.get(`${HOME_ENDPOINTS.HOROSCOPE}/monthly`, {
      params: { sign },
    });
    return response.data;
  },
  ...
  checkCompatibility: async (data1, data2) => {
    const response = await httpClient.post(HOME_ENDPOINTS.MATCHMAKING, {
      person1: data1,
      person2: data2,
    });
    return response.data;
  ...
  getTarotReading: async (question) => {
    const response = await httpClient.post(HOME_ENDPOINTS.TAROT, { question });
    return response.data;
  },

  // Numerology
  getNumerologyReport: async (birthData) => {
    const response = await httpClient.post(HOME_ENDPOINTS.NUMEROLOGY, birthData);
    return response.data;
  },
